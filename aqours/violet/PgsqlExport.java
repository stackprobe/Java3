...
public class PgsqlExport {
	...
	private static void main2() throws Exception {
		new PgsqlExport("si5-vm-share01", 5432, "tottoritestdb", "tottoritestuser", "tottoritestpasswd").perform();
	}
	...
	private static String DEST_ROOT_DIR = "C:/temp/PgsqlExport";
	...
	private void perform() throws Exception {
		...
		try {
			...
			FileTools.rm(DEST_ROOT_DIR);
			FileTools.mkdirs(DEST_ROOT_DIR);

			for(TableInfo ti : tableInfos) {
				String wFile = FileTools.combine(DEST_ROOT_DIR, ti.scheme + "." + ti.name + ".csv");
